 ...
 */
public class IssuesCard {
	
	@FindBy(xpath="//button[@class='btn btn-default dropdown-toggle' and @type='button']")
	WebElement myAccount;
	
	@FindBy(xpath="//a[contains(text(),'Issued Cards')]")
	WebElement issuedCard;
	
	@FindBy(xpath="//form[@name='CardListForm']/table/tbody/tr/td[4]/a/img")
	WebElement frmdate;
	
	@FindBy(xpath="//form[@name='CardListForm']/table/tbody/tr/td[8]/a/img")
	WebElement todate;
	...
	public IssuesCard(WebDriver driver) 
	{
		this.driver=driver;
	}
	public void openIssueCard() 
	{
